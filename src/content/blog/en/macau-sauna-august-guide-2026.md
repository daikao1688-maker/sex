...
- Most venues offer a base booking discount around MOP 100; Number Nine Spa commonly offers around MOP 200
...
| Item | Reference price (MOP) |
|---|---:|
| Sauna bath | 1,899 |
| Wellness massage | 2,699 |
| East-model massage | 3,799 |
| Model massage | 4,799 |
| Influencer talent | 4,999 |
| European massage | 5,099 |
| Global talent | 5,599 |
| Star car-model | 6,099 |
| JP/KR & HK/TW tiers | 6,599 |
...
| Bath only | 999 |
| Basic massage | 1,299 |
| Entry therapist tier | from 2,499 |
| Mid tiers | ~2,899–3,899 |
| High tiers | ~4,999–5,399 |
| Bubble bath add-on | ~500 |
| Service fee | 10% on all items |

Promotions have tightened versus June and prices have edged up. Don't be sold by labels like "buy one get one" — fold the top-up, bubble-bath add-on and the 10% service fee into your maths.
...
| Item | Reference price (MOP) |
|---|---:|
| Bath-only entry plan | 1,088 |
| Mainstream items | from ~3,088 |
| Upper-mid tiers | ~3,088–6,288 |
| Service fee & tourism tax | Included in listed prices |

The MOP 1,088 entry plan currently includes a 90-minute basic massage, and the list price already folds in the 5% service fee and 5% tourism tax — what you see is what you pay.
...
| Item | Reference price (MOP) |
|---|---:|
| Entry / 12 hours | 1,738 |
| Beauty & aromatherapy SPA | 2,398 |
| Theme SPA | ~3,198–5,998 |
...
|---|---:|
| Bath only | 988 |
| Shanghai-style massage | 1,588 |
| Southeast Asian tiers | ~2,788–3,688 |
| European tier | ~3,888 |
| JP/KR tier | ~5,288 |
| Scenario room add-on | ~440 |
...
|---|---:|
| Bath only | 888 |
| Shanghai-style massage | 1,388 |
| Southeast Asian tiers | ~2,888–3,488 |
| European tiers | ~3,488–3,988 |
| JP/KR tier | ~5,288 |
| Service fee & tourism tax | ~10% combined |
...
|---|---:|
| Bath only | 999 |
| Shanghai-style massage | 2,299 |
| Wellness / recovery massage | ~2,799–2,999 |
| Mid spa items | ~3,799–4,399 |
| High spa items | ~5,599–5,999 |
...
**6. Don't casually use novelty products of unknown origin**. Some channels offer extra "gifts" whose source, ingredients and storage are unclear. For anything affecting your body, avoid products you can't verify; if needed, choose legal pharmacy products and consult a doctor or pharmacist first.
