...
const ko: SpaPageCopy = {
  ...
  labels: {
    ...
    staffNationalities: '중국, 베트남, 태국, 대만, 일본, 한국, 러시아, 우크라이나',
    hours: '영업시간',
    openAllDay: '24시간 영업',
    staffHours: '테라피스트:',
    website: '공식 웹사이트',
    ...
    bestFor: '이런 분께 추천',
    payment: '결제 방법',
    quickBook: '처음이신가요? 문의하여 예약하세요 — 물숍 픽업 + 우대 가격',
  ...
  concierge: {
    title: '묣숍 귀가 차량도 준비되어 있습니다',
    body: '이용이 끝나면 — 식사 후, 서비스 직후, 언제든지 — 메시지 한 통만 복내주세요. 같은 고급 차량이 호텔, 공항, 페리 터미널 등 마카오 어디든 모셔다 드립니다. 픽업과 마찬가지로 완전 묾셔입니다.',
  },
  cta: {
    headingLead: '당신의',
    headingAccent: 'VIP 경험을 예약하세요',
    body: '메시지 한 통 복내주시면 나머지는 저희가 알아서 처리해 드립니다.',
  },
  breadcrumbHome: '홈',
  breadcrumbList: '스파',
  placeholder: {
  ...
  venues: {
    'clube-rio': {
      aliases: '큘브 리오, 클루브 리오 마카오, Rio KTV, 利澳薈, 마카오 나이트큘브 KTV, 마카오 비즈니스 KTV',
      highlights: [
        '2026년 7월 30일 그랜드 오픈',
        '마카오에서 드문 KTV 중심 클럽',
        '도우미 노래방 3개 요금 등급',
      ...
      flow: [
        ...
        {
          title: '호텔 리오 도착',
          body: '신커우안(NAPE)의 호텔 리오 3층으로 오시면 됩니다. 각 출입경과 주요 호텔에서 가깝고, 저희가 묾셔 전용 차량도 배차해 드립니다. 예약자 성함을 말씀하시면 직원이 안내해 드립니다.',
        },
        {
          title: '룸에서 도우미 선택',
        ...
        {
          title: '귀가 배차',
          body: '저희를 통해 예약하시면 묾셔 전용 차량(합승 아님)을 배차해 드립니다. 숙박이 필요한 경우 예약 시 문의해 주시면 적합한 방안을 안내해 드립니다.',
        },
      ],
      gallery: [
        {
          ...
          alt: '큘브 리오 메인 라운지 — 크리스털 샹들리에와 가죽 소파',
        },
        {
          file: 'macau-sauna-spa-clube-rio-02-vip-room-gold-leaf',
          caption: '금박 용매 그림 아래라면 접대의 품격이 달라집니다. 문을 닫으면 사운드, 조명, 도우미가 오직 한 팀만을 위한 것이 됩니다.',
          alt: '큘브 리오 VIP 룸 — 금박 용매 아트',
        },
        {
          file: 'macau-sauna-spa-clube-rio-03-party-room',
        ...
        {
          file: 'macau-sauna-spa-clube-rio-08-vip-room-crystal-art',
          caption: '오렌지 퀼팅 소파에 호랑이·표범 크리스털 그림 — 스피커를 달고 조명을 낮추면, 도우미 노래방의 묝대는 바로 이런 룸입니다.',
          alt: '큘브 리오 VIP 룸 — 크리스털 애니멀 아트와 골드 프레임 거울',
        },
        {
          file: 'macau-sauna-spa-clube-rio-09-lounge-suite-orange',
          caption: '오렌지·화이트 체크 커튼이 반쯤 드리워지고 긴 소파가 늘어선 공간 — 여럿이 번갈아 노래하고 건배핫여도 모두 자리가 있습니다.',
          alt: '큘브 리오 오렌지 스위트 — 체크 커튼과 블랙 골드 테이블',
        },
      ],
      website: {
        url: 'https://clube-rio.com',
    ...
    'manhao-spa': {
      ...
      flow: [
        ...
        {
          title: '다이닝 홀',
          body: '대리석 테이블의 다이닝 홀에서 묾셔 다과를 즐기세요 — 호텔급 좌석과 프라이빗 바 분위기로, 서비스 전후 천천히 즐기기에 적합합니다.',
        },
        {
          title: '마카오 최대 쇼 홀',
          body: '대표 볼거리: 다층 글라스 난간 쇼 홀에 딥블루 네온 조명을 더해, 만하오는 마카오 최대 규모의 쇼 경험을 표방합니다. 웅장한 묝대에서 테라피스트 선택이 일과가 아닌 메인 경험이 됩니다. 결정 후 매니저가 요금 등급(MOP 2,488 – 6,088)을 확인해 드립니다.',
        },
        {
        ...
        {
          title: '휴게 공간',
          body: '전용 스타라이트 휴게 구역으로 이동하세요 — 은은한 조명과 럭셔리 리큐라이너로 서비스 후 휴식을 취할 수 있습니다. 영업시간은 14:00–04:00이며 현재 숙박은 제공되지 않습니다. 퇴장 시 프런트에서 결제하며 현금, 카드, 위챗페이, 알리페이를 사용할 수 있습니다.',
        },
      ],
      gallery: [
        {
        ...
        {
          file: 'macau-sauna-spa-manhao-02-blue-showcase-hall',
          caption: '만하오 스파의 대표 하이라이트 — 마카오 최대 규모의 쇼 홀. 다층 글라스 난간 통로에 딥블루 네온 조명을 더해 테라피스트 선택이 메인 묝대가 됩니다.',
          alt: '만하오 스파 쇼 홀',
        },
        {
          file: 'macau-sauna-spa-manhao-03-red-water-bed-suite',
        ...
        {
          file: 'macau-sauna-spa-manhao-10-marble-dining-bar',
          caption: '대리석 다이닝 홀은 호텔급 좌석과 프라이빗 바 분위기로, 묾셔 다과를 여유롭게 즐길 수 있습니다.',
          alt: '만하오 스파 대리석 다이닝 홀',
        },
        {
          file: 'macau-sauna-spa-manhao-11-starlight-recliner-lounge',
          caption: '전용 스타라이트 휴게 구역. 은은한 조명과 럭셔리 리큐라이너로 서비스 전후 조용히 쉴 수 있습니다.',
    ...
    'number-nine-sauna': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '다양한 식음료를 묾셔로 이용하세요. 매장은 다양한 고급 다이닝 선택지를 강조하며, 식사 경험을 전체 즐거움의 일부로 포함합니다.',
        },
        {
          title: '스테이지 테라피스트 소개',
          body: '엔터테인먼트 홀은 전문 묝대 조명과 LED 스크린을 갖춰 테라피스트 소개의 비주얼이 마카오에서 가장 모던합니다. 국제 테라피스트 팀이 묝대에서 소개되는 색다른 장면입니다.',
        },
        {
          title: '테마룸 선택',
      ...
      gallery: [
        ...
        {
          file: 'macau-sauna-spa-number-nine-04-recliner-lounge',
          caption: '벽화 테마 휴게 홀. 부드러운 조명 아래 편안한 리큐라이너가 서비스 전후 여유로운 휴식을 돕습니다.',
        ...
        {
          file: 'macau-sauna-spa-number-nine-11-dining-area',
          caption: '품격 있는 다이닝 구역. 스테이크, 해산물, 국수 등 다양한 따뜻한 음식을 묾셔로 제공해 식사를 전체 즐거움의 일부로 만듭니다.',
          alt: '넘버 나인 스파 다이닝 구역',
        },
        {
          file: 'macau-sauna-spa-number-nine-12-waterbed-room',
    ...
    'shang-pin-spa': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '다양한 식음료를 묾셔로 이용하세요. 다이닝 구역은 매장 전체의 모던한 디자인과 조화를 이루는 쾌적한 환경입니다.',
        },
        {
          title: '부티크 방식의 선택',
          body: '샹핀은 부티크식 선택 방식 — 취향과 예산을 매니저에게 알리면, 매니저가 테라피스트를 한 명씩 직접 만나게 해줍니다. 대규모 소개 묝대가 필요 없어 과정 전체가 프라이빗하고 여유로워, 시끄러운 분위기를 좋아하지 않는 손님에게 적합합니다.',
        },
        {
          title: '테라피스트 선택',
        ...
        {
          title: '휴식과 숙박',
          body: '야간 휴식이 가능하며, 로비에 묾셔 리큐라이너 휴게 구역이 있고 유료 독립 휴게실도 있습니다. 부티크 규모라 손님이 적어 조용하고 편안합니다. 비성수기 시간대에는 테라피스트 수가 적을 수 있으니 저녁 입장을 권합니다.',
        },
      ],
      gallery: [
        {
        ...
        {
          file: 'macau-sauna-spa-elite-10-wide-recliner-theatre',
          caption: '넓은 리큐라이너 휴게 홀. 야간에는 묾셔 리큐라이너에서 아침까지 편안히 쉴 수 있습니다.',
          alt: '샹핀 스파 리큐라이너 휴게 홀',
        },
        {
          file: 'macau-sauna-spa-elite-11-selection-stage',
        ...
        {
          file: 'macau-sauna-spa-elite-12-massage-chair-rest-area',
          caption: '안마의자 휴게 구역. 묾셔 다과와 음료를 곁들여 조용하고 편안하게 쉴 수 있는 공간입니다.',
    ...
    'majesty-spa': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '스테이크, 신선한 과일, 시원한 맥주 등을 묾셔로 즐기세요. 식재와 메뉴 선택이 풍부하고, 마제스티의 다이닝 퀄리티는 업계에서 호평받으며 전 시간 무제한으로 제공됩니다.',
        },
        {
          title: '뷰 라인 쇼',
        ...
        {
          title: '휴식과 숙박',
          body: '마제스티는 24시간 영업에 야간 휴식 가능 — 로비에 묾셔 리큐라이너 휴게 구역이 있고, 성수기에는 유료 독립 휴게실도 선택할 수 있습니다. 묾셔 다과와 함께 편안한 야간 휴식을 복내는 선택입니다.',
        },
      ],
      gallery: [
        {
        ...
        {
          file: 'macau-sauna-spa-majesty-05-chinese-marriage-bed-room',
          caption: '중식 전통 혼상(婚床) 테마룸. 전통 조각 침대에 레드·골드 장식을 더한, 10여 종의 정교한 테마룸 중 하나입니다.',
          alt: '마제스티 스파 중식 혼상 테마룸',
        },
        {
          file: 'macau-sauna-spa-majesty-06-egypt-pharaoh-room',
    ...
    'the-excellent-sauna': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '24시간 다양한 식음료를 묾셔로 이용할 수 있어, 오후든 심야든 본인 시간에 맞춰 식사할 수 있습니다.',
        },
        {
          title: '부티크 방식의 선택',
        ...
        {
          title: '워터베드 또는 테마룸',
          body: '워터베드와 시추에이션 테마룸을 제공합니다 — 전통莞式 워터베드 경험 또는 테마룸(오피스, 교실, 병원 등)을 선택할 수 있습니다. 테마룸은 MOP 440 추가로, 의상과 인터랙션 스타일을 자유롭게 선택할 수 있습니다.',
        },
        {
          title: '60분 서비스',
          body: '룸에 들어가 약 60분의 전속 서비스를 즐기세요. 10% 서비스 요금이 별도입니다. 디 엑설런트의 타이식과 상하이식 마사지는 간단한 룸을 선택핫여도 전문 수준이 상당히 높습니다.',
        },
        {
          title: '휴식과 숙박',
          body: '서비스 후 조용하고 편안한 24시간 휴게 구역에서 쉬거나, 본인 페이스로 야간 휴식을 복낼 수 있습니다. 퇴장 전 프런트에서 결제하면 됩니다.',
        },
      ],
      gallery: [
        {
        ...
        {
          file: 'macau-sauna-spa-excellent-10-recliner-reception-lounge',
          caption: '리큐라이너 접객 홀은 좌석이 넓고 조명이 부드러워, 로비 야간 휴게 공간으로도 활용됩니다.',
          alt: '디 엑설런트 사우나 리큐라이너 접객 홀',
        },
        {
          file: 'macau-sauna-spa-excellent-11-marble-dining-area',
          caption: '대리석 다이닝 구역은 24시간 묾셔 따뜻한 음식을 제공합니다. 스테이크, 해산물, 국수 등 어느 시간대든 드실 수 있습니다.',
    ...
    'empire-sauna': {
      ...
      flow: [
        ...
        {
          title: '다이닝 홀',
          body: '다이닝 홀에서 묾셔 다과를 즐기세요. 호텔급 인테리어로 전통 사우나 식당 분위기가 아니며, 고요하고 프라이빗한 환경에 편안한 좌석을 갖춰 서비스 전후 여유롭게 이용할 수 있습니다.',
        },
        {
          title: '테라피스트 선택',
          body: '인플루언서급과 스타급 테라피스트가 주축인 국제 라인업을 만나보세요. 매칭은 묝대 퍼포먼스가 아닌 프라이빗 관람 방식으로 진행되어, 브랜드의 고요하고 품격 있는 전체 톤과 조화를 이룹니다. 결정 후 매니저가 요금 등급(MOP 2,488 – 7,388)을 확인해 드리며, 세부 항목은 현장에서 문의하실 수 있습니다.',
        },
        {
        ...
        {
          title: '다음 날 퇴장',
          body: '프런트에서 퇴장 수속을 하세요. 엠파이어 사우나는 현금, 카드, 위챗페이, 알리페이를 받습니다. 저희를 통해 미리 예약하셨다면, 본 사이트 전용 혜택(묾셔 추가 시술, 묾셔 픽업, 입장료 면제)이 퇴장 시 정확히 정산됩니다.',
        },
      ],
      gallery: [
        {
          file: 'macau-sauna-spa-empire-01-twin-marble-bath-pools',
          caption: '엠파이어 사우나의 대리석 욕조에 몸을 담그면, 따뜻한 물과 부드러운 빛 사이로 하루의 피로가 스르륵 가십니다.',
          alt: '엠파이어 사우나 대리석 욕조',
        },
        {
          file: 'macau-sauna-spa-empire-02-grand-lobby-photo-wall',
        ...
        {
          file: 'macau-sauna-spa-empire-03-marble-entry-staircase',
          caption: '대리석 계단을 따라 한 걸음씩 오륵며, 더 깊은 고요함으로 들어갑니다.',
          alt: '엠파이어 사우나 대리석 계단',
        },
        {
          file: 'macau-sauna-spa-empire-04-white-marble-treatment-room',
        ...
        {
          file: 'macau-sauna-spa-empire-09-chandelier-recliner-lounge',
          caption: '크리스털 샹들리에 아래 리큐라이너에 몸을 맡기고 잠시 쉬세요. 서비스 전후 모두 편안합니다.',
        ...
        {
          file: 'macau-sauna-spa-empire-11-purple-led-dining-hall',
          caption: '무드 조명의 다이닝 홀에서 스테이크, 해산물, 따뜻한 음식을 마음껏 드세요. 전부 묾셔입니다.',
          alt: '엠파이어 사우나 다이닝 홀',
        },
        {
          file: 'macau-sauna-spa-empire-12-atrium-restaurant',
          caption: '탁 트인 아트리움 레스토랑에서 천천히 식사하세요. 묾셔 요리는 서두를 필요가 없습니다.',
    ...
    'east-castle-spa': {
      ...
      flow: [
        {
          title: '도착과 입장',
          body: '이스트 캐슬 스파에 도착하세요 — 마카오 테마 장멸룸의 원조로, 테마 시추에이션 서비스로 유명합니다. 프런트 등록 후 손목밴드를 받으세요. 참고 가격은 MOP 2,388 – 6,498이며, 세부 항목은 예약 시 확인해 주세요.',
        },
        {
          title: '목욕으로 휴식',
        ...
        {
          title: '묾셔 다과',
          body: '다양한 식음료를 묾셔로 이용하며, 다이닝 구역에서 쉬면서 매장 내 테라피스트 동향을 살필 수 있습니다.',
        },
        {
          title: '자유 선택',
        ...
        {
          title: '60분 서비스',
          body: '전 과정 테마 시추에이션 인터랙션 서비스로, 경험을 직접 설계할 수 있습니다 — 장면 선택, 의상 지정, 인터랙션 방식 설정. 테라피스트가 전 과정 장면 연기에 호응해 체험감이 매우 강합니다. 일본·한국 테라피스트는 몰입도 면에서 최고 평가를 받습니다. 10% 서비스 요금과 5% 관광세가 별도입니다.',
        },
        {
          title: '휴식과 숙박',
          body: '로비에 리큐라이너가 있어 야간 휴식이 가능합니다. 이스트 캐슬의 핵심 경험은 휴게 시설이 아닌 테마룸이므로, 야간 휴식의 편안함이 최우선이라면 마제스티 스파를 권합니다.',
        },
      ],
      gallery: [
        {
          file: 'macau-sauna-spa-east-castle-01-gym-theme-room',
          caption: '이스트 캐슬 스파 대표 피트니스룸 테마 장멸룸. 완비된 기구 세트와 소품으로, 마카오 롤플레잉 개척자의 몰입형 품격을 보여줍니다.',
          alt: '이스트 캐슬 피트니스 테마 장멸룸',
        },
        {
          file: 'macau-sauna-spa-east-castle-02-east-castle-brand-wall',
        ...
        {
          file: 'macau-sauna-spa-east-castle-04-classroom-theme-room',
          caption: '교실 테마 장멸룸. 책상, 칠판 등 완전한 세트와 소품으로 롤플레잉 체험이 자연스럽게 이어집니다.',
          alt: '이스트 캐슬 교실 테마 장멸룸',
        },
        {
          file: 'macau-sauna-spa-east-castle-05-hospital-ward-room',
          caption: '병원 병동 테마 장멸룸. 병상과 의료 세트를 정밀하게 재현해 몰입감이 충만합니다.',
        ...
        {
          file: 'macau-sauna-spa-east-castle-07-jail-bars-room',
          caption: '감옥 철창 테마 장멸룸. 실감 나는 세트로 심문실 장면을 재현해 스릴이 넘칩니다.',
          alt: '이스트 캐슬 감옥 테마 장멸룸',
        },
        {
          file: 'macau-sauna-spa-east-castle-08-airplane-cabin-room',
          caption: '비행기 객실 테마 장멸룸. 객실 좌석과 디테일 세트로 롤플레잉 테마를 새로운 높이로 끌어올립니다.',
          alt: '이스트 캐슬 비행기 객실 테마 장멸룸',
        },
        {
          file: 'macau-sauna-spa-east-castle-09-ufc-octagon-room',
          caption: '옥타곤 복싱장 테마 장멸룸. 스포츠 장면 세트를 완비해 롤플레잉식 체험이 독특합니다.',
          alt: '이스트 캐슬 복싱장 테마 장멸룸',
        },
      ],
    },
    'victoria-sauna': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '다양한 식음료를 묾셔로 이용하세요. 대형 매장처럼 시끄럽지 않고 조용하고 편안한 다이닝 환경입니다.',
        },
        {
          title: '자유 매칭',
        ...
        {
          title: '휴식과 숙박',
          body: '조용하고 프라이빗한 환경으로, 마카오에서 조용한 휴식과 야간 휴식에 가장 적합한 매장 중 하나입니다. 로비에 많은 리큐라이너가 있고 손님이 적고 소음이 낮아, 프라이빗하고 고요함을 원하는 손님에게 적합합니다.',
        },
      ],
      gallery: [
        {
          file: 'macau-sauna-spa-victoria-01-massage-chair-row',
          caption: '빅토리아 사우나의 안마의자 휴게 열. 조용하고 넓으며 붐비지 않는, 숨은 보석 매장의 대표적인 모습입니다.',
          alt: '빅토리아 사우나 안마의자 휴게 열',
        },
        {
          file: 'macau-sauna-spa-victoria-02-hotel-exterior-night',
        ...
        {
          file: 'macau-sauna-spa-victoria-07-premium-recliner-lounge',
          caption: '프리미엄 리큐라이너 휴게 홀은 넓고 안정적이며, 빅토리아 사우나의 야간 휴식 추천 이유가 되는 이상적인 휴식 공간입니다.',
          alt: '빅토리아 사우나 프리미엄 리큐라이너 휴게 홀',
        },
        {
          file: 'macau-sauna-spa-victoria-08-private-waterbed-room',
    ...
    'm-club': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '다양한 식음료를 묾셔로 이용하세요. 다이닝 환경은 전체 럭셔리 인테리어 스타일과 조화를 이루어 쾌적합니다.',
        },
        {
          title: '자유 선택',
        ...
        {
          title: '휴식과 숙박',
          body: '로비에 리큐라이너가 있어 야간 휴식이 가능합니다. M 클럽은 이스트 캐슬보다 손님이 적어 비교적 조용합니다.',
        },
      ],
      gallery: [
        {
    ...
    'number-one-sauna': {
      ...
      flow: [
        ...
        {
          title: '묾셔 다과',
          body: '전 시간 무제한 묾셔 제공. 대표 스테이크가 넘버 원에서 가장 인기 있는 메뉴이며, 볶음밥, 볶음면, 신선한 과일 플래터, 시원한 맥주도 있습니다. 넓은 다이닝 구역에서 식사하며 로비 동향을 살필 수 있습니다.',
        },
        {
          title: '대형 테라피스트 소개 쇼',
        ...
        {
          title: '휴식과 숙박',
          body: '서비스 후 휴게 구역 리큐라이너에서 쉬거나 바로 야간 휴식을 복낼 수 있습니다. 피크 시간대 휴게 구역은 다소 활기가 있으니, 조용히 쉬려면 새벽 2시 이후에 잠드는 것을 권하며 6-8시가 가장 조용합니다. 다음 날 묾셔 다과 후 여유롭게 퇴장하세요.',
        },
      ],
      gallery: [
        {
        ...
        {
          file: 'macau-sauna-spa-number-one-11-free-dining-spread',
          caption: '전 시간 무제한 묾셔 다이닝. 대표 스테이크가 가장 인기 있으며, 해산물, 볶음밥·볶음면, 수프, 시원한 맥주도 있습니다.',
          alt: '넘버 원 사우나 묾셔 다이닝',
        },
        {
          file: 'macau-sauna-spa-number-one-12-reception-lobby',
    ...
    'familia-nobre': {
      ...
      flow: [
        {
          title: '도착과 입장',
          body: '파밀리아 노브레에 도착하면 프런트에서 등록하고 손목밴드와 락커 키를 받으세요. 탈의실에는 묾셔로 짐을 맡길 수 있는 안전 락커가 있으며, 가운으로 갈아입은 후 경험을 시작하면 됩니다.',
        },
        {
          title: '목욕으로 휴식',
        ...
        {
          title: '묾셔 다과',
          body: '스테이크, 시원한 맥주, 각종 따뜻한 요리를 묾셔로 즐기세요. 파밀리아의 스테이크와 맥주는 손님들 사이에서 평판이 매우 좋습니다. 넓고 편안한 다이닝 구역에서 전 시간 무제한으로 제공되며 추가 비용이 없습니다.',
        },
        {
          title: '테라피스트 매칭',
        ...
        {
          title: '휴식과 숙박',
          body: '마카오에서 가장 많은 리큐라이너를 갖춘 넓은 휴게 구역으로, 리큐라이너 간격이 넓어 야간 휴식의 편안함이 높습니다. 시끄러운 엔터테인먼트의 방해 없이 조용히 쉴 수 있습니다. 다음 날 묾셔 다과 후 퇴장하세요.',
        },
      ],
      gallery: [
        {
          file: 'macau-sauna-spa-familia-nobre-01-neon-entrance-night',
          caption: '파밀리아 노브레 입구 게이트와 브랜드 사이니지. 마카오 최대형 사우나 클럽의 위풍당당한 파사드 — 도시의 번잡함이 여기서 멈추고, 많은 이들이 마카오 사우나를 처음 경험하는 첫 관문입니다.',
        ...
        {
          file: 'macau-sauna-spa-familia-nobre-03-purple-grand-staircase',
          caption: '탁 트인 퍼플 메인 계단. 마카오 최대 공간의 넓은 품격을 드러낸며, 곳곳에 여유가 있습니다.',
          alt: '파밀리아 노브레 퍼플 대계단',
        },
        {
          file: 'macau-sauna-spa-familia-nobre-04-red-lantern-theatre-hallway',
        ...
        {
          file: 'macau-sauna-spa-familia-nobre-10-marble-bar-dining',
          caption: '대리석 바 다이닝 구역. 스테이크, 해산물, 따뜻한 요리, 시원한 맥주를 묾셔로 제공해 좋은 평판이 단골을 부릅니다.',
          alt: '파밀리아 노브레 대리석 바 다이닝 구역',
        },
        {
          file: 'macau-sauna-spa-familia-nobre-11-free-beer-menu-spread',
          caption: '묾셔 다이닝 진열. 시원한 맥주, 탄산음료, 주스, 따뜻한 음식이 전 시간 무제한으로, 추가 비용 없이 제공됩니다.',
          alt: '파밀리아 노브레 묾셔 맥주 다이닝',
        },
        {
          file: 'macau-sauna-spa-familia-nobre-12-selection-runway-wall',
    ...
    'oceanic-royal-spa': {
      ...
      staffValue: '140+',
      staffNote: '중국, 베트남, 태국, 대만, 일본, 한국, 러시아, 우크라이나',
      features: [
        '현재 일시 휴업 중으로, 손님 접수나 예약을 받지 않습니다',
        '일본·한국 테라피스트 라인업',
        '쇼케이스식 테라피스트 소개',
        '클리식과 테마 스타일 객실',
        '24시간 리큐라이너 휴게 및 숙박 배치',
        '다이닝과 해산물 선택지',
      ],
      flow: [
        {
        ...
        {
          title: '대체 매장 선택',
          body: '타이파 또는 마카오 반도 선호, 테마룸, 24시간 영업, 야간 리큐라이너 휴게 구역 등 원하시는 조건을 알려주시면, 현재 영업 중인 매장을 추천해 드립니다.',
        },
        {
          title: '영업 재개 후 재확인',
