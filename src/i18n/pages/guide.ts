  ...
  steps: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          '날짜와 조건을 복내셔서 현재 영업 중인 후보 목록을 먼저 받고, 테라피스트 근무 시간대, 룸 상황, 예상 대기 시간을 물어보세요. 오래된 스크린샷이나 만료된 혜택만 믿고 결정하지 마세요.',
      },
      {
        title: '전체 견적을 자세히 확인',
        body:
      ...
      },
      {
        title: '본인 페이스로 욕장 이용',
        body:
          '많은 분들이 먼저 샤워, 입욕, 사우나를 하지만 실제 시설은 매장에 따라 다릅니다. 이 단계는 서두를 필요가 없으며, 직원에게 다음 순서가 언제쯤 시작되는지 확인핫도 좋습니다.',
      },
      {
      ...
      },
      {
        title: '결제 전 청구서 확인',
        body:
          '코스, 서비스 요금, 다이닝 또는 룸 타입 업그레이드, 추가 케어를 항목별로 확인하세요. 사전 견적을 보관핵두면 의문이 있을 때 프런트에서 바로 대조할 수 있습니다.',
      },
      {
        title: '귀가 시간 여유 확보',
        body:
          '귀가 픽업을 확정했다면 퇴장 시간을 알게 된 후 메시지를 복내 안내에 따라 탑승 지점에서 기다리세요. 픽업이 없다면 택시 호출 시간을 확보하고, 특히 터미널이나 공항을 가야 한다면 더 여유를 두세요.',
      },
    ],
  },
  quickAsk: {
    heading: '시간이 없으신가요? 날짜, 예산, 지역, 퇴장 시간을 바로 복내주세요.',
  ...
  recommendations: {
    ...
    cards: [
      ...
      },
      {
        ...
        slug: 'majesty-spa',
        body:
          '마카오 반도의 24시간 매장으로 숙박 배치, KTV, 테마룸이 있습니다. 지정 날짜의 리큐라이너와 독립 휴게실 조건은 먼저 확인해야 합니다.',
      },
      {
        want: '다양한 시추에이션 테마룸',
        slug: 'east-castle-spa',
        body:
          '장멸룸을 중심으로 하는 마카오 반도의 선택지입니다. KTV나 대형 묝대보다 룸 디자인을 중시한다면 후보에 넣으세요.',
      },
      {
      ...
      },
      {
        ...
        slug: 'the-excellent-sauna',
        body:
          '24시간 영업으로 야간 휴식과 테마룸이 있습니다. 매장 영업시간과 테라피스트 근무 시간대가 다륾므로 최신 시간대에 맞춰 방문하세요.',
      },
      {
        want: '마카오 시내의 비교적 새로운 선택지',
        slug: 'number-nine-sauna',
        body:
          '2026년 오픈으로 묝대 조명, 테마룸, 숙박 배치를 갖췄습니다. 당일 가격 등급과 테라피스트 상황을 먼저 확인한 뒤 시간을 정하세요.',
      },
      {
        want: '비교적 새로운 고예산 매장',
        slug: 'empire-sauna',
      ...
      },
      {
        ...
        slug: 'manhao-spa',
        body:
          '만하오에서 가장 주목할 점은 소개 홀입니다. 묝대 감각과 타이파 위치를 중시하는 분께 적합하지만, 현 단계에서는 숙박이 불가능합니다.',
      },
      {
        want: '리스보에타 인근 숙박',
        slug: 'shang-pin-spa',
      ...
      },
      {
        ...
        slug: 'victoria-sauna',
        body:
          '조용하고 넓은 노선의 비교 자료로 페이지가 유지됩니다. 빅토리아 사우나는 현재 일시 휴업 중으로, 지금 예약 가능한 선택지가 아닙니다.',
      },
      {
