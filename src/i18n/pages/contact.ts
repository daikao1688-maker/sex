...
const ko: ContactPageCopy = {
  meta: {
    ...
    description: '날짜, 인원, 예산, 픽업 위치를 마카오 사우나 가이드에 보내주시면 매장 영업 상태, 당일 가격, 숙박 및 픽업 배차를 확인한 뒤 예약 여부를 결정하실 수 있습니다.',
  },
  breadcrumbs: [
    {
      name: '홈',
  ...
  heading: '문의하기',
  intro: '매장을 비교하거나, 가격을 문의하거나, 픽업 배차 방식이 궁금하신가요? 아래에서 연락 방법을 골라 날짜, 시간, 인원을 보내주세요. 저희가 현재 영업 중인 매장을 먼저 확인한 뒤 일정과 관련된 세부 사항을 확인하고, 명확히 안내한 후에 예약을 진행합니다.',
  backHome: '홈으로 돌아가기',
  ...
  discreet: {
    heading: '배치에 필요한 정보만 요청합니다',
    body: '저희는 문의에 답하고, 요청하신 예약과 픽업을 처리하는 데 필요한 정보만 요청합니다. 관계없는 개인 정보는 보내지 않으셔도 됩니다. 자세한 처리 방식은 개인정보 안내를 확인해 주세요.',
    link: '개인정보 안내 →',
  },
  faq: {
    heading: '메시지 보내기 전 자주 묻는 질문',
    items: [
      {
        question: '메시지를 보낸 후 어떻게 처리되나요?',
