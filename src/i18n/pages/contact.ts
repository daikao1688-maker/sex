...
const ko: ContactPageCopy = {
  meta: {
    title: '문의하기 - 마카오 사우나 가이드',
    description: '날짜, 인원, 예산, 픽업 위치를 마카오 사우나 가이드에 복내주시면 매장 영업 상태, 당일 가격, 숙박 및 픽업 배차를 확인한 뒤 예약 여부를 결정하실 수 있습니다.',
  },
  breadcrumbs: [
    {
      name: '홈',
  ...
  eyebrow: '확정된 정보를 먼저 알려주세요',
  heading: '문의하기',
  intro: '매장을 비교하거나, 가격을 문의하거나, 픽업 배차 방식이 궁금하신가요? 아래에서 연락 방법을 골라 날짜, 시간, 인원을 복내주세요. 저희가 현재 영업 중인 매장을 먼저 확인한 뒤 일정과 관련된 세부 사항을 확인하고, 명확히 안내한 후에 예약을 진행합니다.',
  backHome: '홈으로 돌아가기',
  channelsHeading: '평소 사용하시는 연락 방법을 선택하세요',
  promises: [
    {
      icon: 'clock',
      title: '날짜와 시간을 먼저 알려주세요',
      body: '매장 상황과 테라피스트 시간대는 매일 다릅니다. 방문 예정일과 대략적인 도착 시간을 알려주시면 그 시점의 영업 및 배치를 먼저 확인할 수 있습니다.',
    },
    {
      icon: 'car',
      title: '픽업이 필요하면 위치를 적어주세요',
      body: '픽업이 필요하시면 호텔, 출입경, 터미널, 공항과 출발 가능 시간을 알려주세요. 배차 가능 여부를 확인하고 출발 전 집결 지점을 확정해 드립니다.',
    },
    {
      icon: 'gift',
      title: '예약 전 당일 조건 확인',
      body: '가격, 영업시간, 숙박 규칙, 행사는 모두 조정될 수 있습니다. 이번 문의에서 확인된 내용을 설명드리며, 매장 측 별도 비용이 있으면 함께 안내합니다.',
    },
  ],
  whatToSend: {
    heading: '첫 메시지는 이렇게 쓰시면 됩니다',
    intro: '아래 정보를 간단히 첨부해 주시면 바로 확인을 시작할 수 있습니다:',
    items: [
      '고려 중인 매장, 또는 원하시는 분위기와 유형',
      '방문 예정일과 대략적인 도착 시간',
      '인원',
      '픽업이 필요하면 탑승 위치',
      '예산 범위와 반드시 필요한 조건',
  ...
  discreet: {
    heading: '배치에 필요한 정볼만 요청합니다',
    body: '저희는 문의에 답하고, 요청하신 예약과 픽업을 처리하는 데 필요한 정볼만 요청합니다. 관계없는 개인 정보는 복내지 않으셔도 됩니다. 자세한 처리 방식은 개인정보 안내를 확인해 주세요.',
    link: '개인정보 안내 →',
  },
  faq: {
    heading: '메시지 복내기 전 자주 묻는 질문',
    items: [
      {
        question: '메시지를 복낸 후 어떻게 처리되나요?',
        answer: '매장의 영업 상태와 고객님의 필요와 관련된 시간대 및 배치를 먼저 확인합니다. 정보가 부족하면 필요한 질문 한두 가지를 먼저 여쭤본 뒤, 현재 가능한 선택지를 안내합니다.',
      },
      {
        question: '실제 가격은 언제 알 수 있나요?',
        answer: '매장이 선택하신 날짜의 가격과 포함 내용을 확인하면, 저희가 먼저 설명드린 뒤 고객님이 결정하시면 됩니다. 예약금, 서비스 요금, 추가 항목이 해당되는 경우에도 예약 확정 전에 확인하시기 바랍니다.',
      },
      {
        question: '어떤 개인 정보를 제공해야 하나요?',
        answer: '처음에는 날짜, 인원, 예산, 픽업 위치만 필요합니다. 이후 배치에 다른 정보가 꼭 필요해지면 용도를 먼저 설명드린 뒤 보완을 요청드립니다.',
      },
      {
        question: '어떤 메신저를 사용해야 하나요?',
        answer: 'WhatsApp, WeChat, Line, Telegram 모두 가능하니 가장 자주 사용하시는 것을 선택하세요. 이후 일정을 변경할 때도 같은 대화를 이어가면 진행이 수월합니다.',
      },
      {
        question: '당일 급히 출발하는 경우에도 문의할 수 있나요?',
        answer: '가능합니다. 가장 빠른 출발 가능 시간과 현재 계신 지역을 알려주시면, 당일 매장과 차량 상황을 먼저 확인한 뒤 가능한 선택지를 회신드립니다.',
      },
    ],
  },
  next: {
    ...
    links: [
      {
        label: '매장 랭킹과 가격 범위 비교',
        path: '/ranking/',
      },
      {
        label: '처음이신가요? 전체 흐름 먼저 보기',
        path: '/guide/',
      },
      {
        label: '픽업 배차 방식 알아보기',
