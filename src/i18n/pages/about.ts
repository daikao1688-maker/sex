...
const en: AboutCopy = {
  meta: {
    ...
    description: 'Learn how Macau Sauna Sites organises information on {venueCount} venue profiles, keeps changing details in view, and helps visitors compare their options before booking.',
  },
  breadcrumbs: [
    {
      name: 'Home',
  ...
  intro: '{brand} brings {venueCount} venue profiles into one practical guide. We organise opening status, price ranges, locations, overnight arrangements and venue features, then reconfirm details that may change before a booking. The aim is simple: help you compare the options without having to piece everything together yourself.',
  ...
  trust: {
    ...
    note: 'The directory contains {venueCount} venue profiles, including venues that may be temporarily closed. Opening status, prices, hours, staff availability, overnight arrangements and transport can change, so the latest details should always be reconfirmed before a visit.',
  },
  why: {
...
const ja: AboutCopy = {
  meta: {
    ...
    description: 'マカオのサウナ{venueCount}店舗について、営業状況、料金の目安、場所、宿泊可否などを整理し、来店前の比較と確認をお手伝いするサイトです。',
  },
  breadcrumbs: [
    {
      name: 'ホーム',
  ...
  intro: '{brand} は、マカオのサウナ{venueCount}店舗について、営業状況、料金の目安、場所、宿泊可否、各店の特徴を一か所にまとめた案内サイトです。予約前には、変更されやすい情報をあらためて確認します。初めての方でも、必要な情報を探し回らずに比較できることを目指しています。',
  brand: 'マカオ・サウナ・ガイド',
  backHome: 'ホームに戻る',
  services: {
  ...
  trust: {
    ...
    note: '当サイトには、営業中の店舗だけでなく、一時休業中の店舗を含む{venueCount}件の情報を掲載しています。営業状況、料金、営業時間、スタッフの勤務状況、宿泊、送迎は変更される場合があるため、来店前に最新情報をご確認ください。',
  },
  why: {
    heading: 'このサイトを作った理由',
    paragraphs: [
...
const zhTW: AboutCopy = {
  meta: {
    title: '關於我們 - 澳門桑拿導航站',
    description: '了解澳門桑拿導航站如何整理 {venueCount} 間場所資料、標示營業狀態，並在預約前協助核實價格、時段、過夜及接送安排。',
  },
  breadcrumbs: [
    {
      name: '首頁',
  ...
  intro: '{brand} 收錄 {venueCount} 間場所，將營業狀態、價格範圍、所在區域、過夜安排與場所特色放在同一個網站，方便您逐間比較。預約前，我們亦會就容易變動的資料再次核實，讓第一次接觸澳門桑拿的人也能先看懂、再決定。',
  brand: '澳門桑拿導航站',
  backHome: '返回首頁',
  services: {
    heading: '我們如何協助您做選擇',
  ...
  trust: {
    ...
    note: '網站收錄 {venueCount} 間場所，當中亦包括目前暫停營業的場所。營業狀態、價格、時段、技師安排、過夜及接送均可能變動，請在出發前以最新確認為準。',
  },
  why: {
    heading: '為何建立這個網站',
    paragraphs: [
...
const zhCN: AboutCopy = {
  meta: {
    title: '关于我们 - 澳门桑拿导航站',
    description: '了解澳门桑拿导航站如何整理 {venueCount} 家场所的信息和营业状态，并在预约前协助确认价格、时段、过夜及接送安排。',
  },
  breadcrumbs: [
    {
      name: '首页',
  ...
  headingLead: '把澳门桑拿信息',
  headingAccent: '整理得更清楚',
  intro: '{brand} 收录了 {venueCount} 家场所，把营业状态、价格范围、所在区域、过夜安排和场所特点集中到同一个网站，方便逐项比较。预约前，我们也会重新确认容易变化的信息，让第一次了解澳门桑拿的人可以先看明白，再做决定。',
  brand: '澳门桑拿导航站',
  backHome: '返回首页',
  services: {
    heading: '我们怎样帮您做选择',
  ...
  trust: {
    ...
    note: '网站收录 {venueCount} 家场所，其中也包括目前暂停营业的场所。营业状态、价格、时段、技师安排、过夜和接送都可能变化，请以出发前的最新确认为准。',
  },
  why: {
    heading: '为什么建立这个网站',
    paragraphs: [
...
const ko: AboutCopy = {
  meta: {
    ...
    description: '마카오 사우나 가이드가 {venueCount}개 매장의 정보와 영업 상태를 어떻게 정리하는지, 그리고 예약 전 가격, 시간, 숙박, 픽업 배차를 어떻게 확인해 드리는지 알아보세요.',
  },
  breadcrumbs: [
    {
      name: '홈',
  ...
  intro: '{brand}은(는) {venueCount}개 매장을 수록하며, 영업 상태, 가격 범위, 소재 지역, 숙박 배치, 매장 특징을 한 사이트에 모아 항목별로 비교할 수 있게 합니다. 예약 전에는 변동되기 쉬운 정보를 다시 확인해, 마카오 사우나를 처음 알아보는 분도 먼저 이해하고 결정할 수 있도록 돕습니다.',
  brand: '마카오 사우나 가이드',
  backHome: '홈으로 돌아가기',
  services: {
    heading: '선택을 돕는 방식',
  ...
  trust: {
    ...
    note: '사이트에는 현재 일시 휴업 중인 매장을 포함해 {venueCount}개 매장이 수록되어 있습니다. 영업 상태, 가격, 시간대, 테라피스트 배치, 숙박, 픽업은 모두 변동될 수 있으니 출발 전 최신 확인을 기준으로 하세요.',
  },
  why: {
    ...
    paragraphs: [
      ...
      '그래서 마카오 사우나 가이드를 만들어 비교 가능한 정보를 먼저 정리했습니다. 각 매장을 직접 살펴보실 수 있고, 도움이 필요하시면 날짜, 숙박 지역, 예산, 중요하게 생각하는 조건을 알려주세요. 범위를 좁힌 뒤 일정과 관련된 최신 정보를 확인해 드립니다.',
    ],
  ...
  cta: {
    ...
    body: '날짜, 숙박 지역, 예산, 취향을 보내주시면 현재 이용 가능한 매장을 함께 비교해 드립니다.',
  },
};
...
const getRawAboutCopy = createPageCopy(aboutCopy);

export function getAboutCopy(lang: Locale): AboutCopy {
  const copy = getRawAboutCopy(lang);
  return {
    ...copy,
    meta: { ...copy.meta, description: formatVenueCount(copy.meta.description) },
    intro: formatVenueCount(copy.intro),
    trust: {
      ...copy.trust,
      stats: copy.trust.stats.map((stat) => ({ ...stat, value: formatVenueCount(stat.value) })),
      note: formatVenueCount(copy.trust.note),
    },
  };
}
