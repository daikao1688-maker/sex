...
const ko: ShuttleCopy = {
  ...
  intro: '픽업이 필요하시면 정확한 탑승 지점, 날짜, 희망 시간, 인원, 짐 상황을 한 번에 알려주세요. 매장이 정해졌다면 이름도 함께 복내주세요. 저희가 예약, 경로, 배차 가능 차량을 먼저 확인한 뒤 집결 위치와 픽업 시간대를 회신드립니다. 이 정보를 확인하셔야 픽업 배차가 정식으로 완료됩니다. 귀가 차량도 목적지, 경로, 시간대에 따라 별도로 확인이 필요합니다.',
  backHome: '홈으로 돌아가기',
  coverage: {
  ...
  howItWorks: {
    heading: '배차 방법',
    steps: [
      '탑승 지점, 날짜, 희망 시간, 인원, 짐 정보를 복내주세요. 매장이 정해졌다면 함께 알려주세요.',
  ...
  cta: {
    ...
    body: '탑승 지점, 날짜, 시간, 인원, 짐 정보를 복내주시면 매장 예약과 함께 확인한 뒤, 배차 가능한 픽업 내용을 회신드립니다.',
  },
  next: {
