...
const ko: ShuttleCopy = {
  meta: {
    title: '마카오 사우나 픽업 - 마카오 사우나 가이드',
    description: '사우나 픽업 신청 시 탑승 지점, 날짜, 시간, 인원, 짐 정보를 알려주세요. 저희가 경로와 차량 상황을 확인한 후, 확정 회신을 받아야 배차가 완료됩니다.',
  },
  breadcrumbs: [
    {
      name: '홈',
  ...
  eyebrow: '경로 먼저 확인・확정 후 배차 완료',
  heading: '마카오 사우나 픽업 배차',
  intro: '픽업이 필요하시면 정확한 탑승 지점, 날짜, 희망 시간, 인원, 짐 상황을 한 번에 알려주세요. 매장이 정해졌다면 이름도 함께 보내주세요. 저희가 예약, 경로, 배차 가능 차량을 먼저 확인한 뒤 집결 위치와 픽업 시간대를 회신드립니다. 이 정보를 확인하셔야 픽업 배차가 정식으로 완료됩니다. 귀가 차량도 목적지, 경로, 시간대에 따라 별도로 확인이 필요합니다.',
  backHome: '홈으로 돌아가기',
  coverage: {
    heading: '픽업 범위는 경로와 시간대로 확정',
    body: '마카오 반도, 타이파, 코타이가 자주 문의되는 지역입니다. 호텔, 출입경, 터미널, 공항은 지정 탑승 구역으로 이동이 필요할 수 있으며, 배차 가능 여부는 도로 상황, 정차 제한, 당시 차량 스케줄에 따라 달라집니다.',
    areas: [
      '마카오 반도 · 경로 확인 필요',
      '타이파와 코타이 · 경로 확인 필요',
    ],
  ...
  pickupPoints: {
    heading: '자주 이용하는 탑승 지점',
    items: [
      '관자(拱北), 칭마오(青茂), 헝친(橫琴) 출입경 지정 집결지',
      '홍콩-주하이-마카오 대교 출입경 탑승 구역',
      '타이파 페리 터미널 또는 아우터 하버 터미널 탑승 구역',
      '마카오 국제공항 지정 집결지',
      '호텔 로비 또는 인근 약속 탑승 지점',
      '코타이 스트립 및 골든 애비뉴 탑승 구역',
    ],
  },
  howItWorks: {
    heading: '배차 방법',
    steps: [
      '탑승 지점, 날짜, 희망 시간, 인원, 짐 정보를 보내주세요. 매장이 정해졌다면 함께 알려주세요.',
      '저희가 경로와 차량 스케줄을 확인한 뒤 집결지와 픽업 시간대를 드립니다. 양측이 내용을 확인해야 배차가 정식으로 성립됩니다.',
      '귀가 차량이 필요하면 목적지와 대략적인 시간을 미리 알려주세요. 귀가 차량은 당시 경로와 스케줄에 따라 별도로 확정됩니다.',
    ],
  },
  included: {
    heading: '확정된 픽업 배차에 포함되는 내용',
    items: [
      '약속 탑승 지점에서 예약 매장까지 이동',
      '경로와 시간이 맞을 때의 귀가 차량 조율',
      '신고 인원과 짐 수요에 맞는 적합 차량 확인',
      '교통 또는 차량 스케줄 변동 시 업데이트 제공',
    ],
    tip: '귀가 차량 팁: 퇴장 시간과 목적지를 최대한 일찍 알려주세요. 저희가 확정된 귀가 집결 정보를 회신드리기 전까지는 귀가 차량이 배정된 것으로 간주하지 마세요.',
  },
  cta: {
    heading: '픽업 경로를 먼저 확인하고 싶으신가요?',
    body: '탑승 지점, 날짜, 시간, 인원, 짐 정보를 보내주시면 매장 예약과 함께 확인한 뒤, 배차 가능한 픽업 내용을 회신드립니다.',
  },
  next: {
  ...
  schema: {
    name: '마카오 사우나 픽업 배차',
    description: '사우나 예약에 맞춘 픽업 조율. 탑승 지점, 날짜, 시간, 인원, 짐 정보를 알려주시면 경로와 차량 상황에 따라 배차를 확정합니다.',
    serviceType: 'Sauna booking shuttle coordination',
  },
};
