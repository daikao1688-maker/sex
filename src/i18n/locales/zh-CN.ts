  ...
  spas: {
    ...
    venues: {
      ...
      'manhao-spa': {
        ...
        badge: '2026 年新开业',
        description:
          "曼濠水疗于 2026 年 5 月在氹仔君怡酒店开业，邻近威尼斯人与银河度假城一带。会所以宽敞空间和雅致装潢营造舒适氛围，云石墙面、金色细节与开阔的公共区域相互呼应，让到访后的节奏自然放慢。\n\n沐浴区以大理石铺设，配有两座浴池、芬兰式桑拿及蒸汽浴室。泡浴、干蒸和蒸汽浴各有不同体感，可以按自己的习惯安排，在行程之间或一天游览后，留一段时间好好休息。",
      },
      'number-nine-sauna': {
        name: '玖号水疗',
        badge: '新场 & 现代设施',
        description:
          '玖号水疗位于御龙酒店内，是 2026 年开业的市中心水疗会所。金色与大理石元素搭配灯光、LED 屏幕及宽敞大厅，呈现鲜明的现代风格。\n\n房间以红色、粉紫和蓝紫等色调搭配星空天花，各有不同氛围。馆内提供日式、韩式及巴厘岛风格按摩，亦设沐浴与休息空间。预约前可按疗程内容、时长及预算比较方案，并确认当日价格与优惠。',
      },
      'shang-pin-spa': {
        name: '尚品国际水疗',
        badge: '性价比极高',
        description:
          '尚品国际水疗位于澳门葡京人二楼 L2 R95，属于路氹区较新的高端水疗场所。公开介绍提到场地约 20,000 平方英尺，以日式风格装修，设有按摩浴池、桑拿浴室与日式沐浴房；整体氛围明亮干净，更接近现代酒店水疗的环境。\n\n宽敞的沐浴区与安静的休息空间，适合在游览之间放慢脚步。住在葡京人、上葡京或路氹一带的客人，可按行程选择合适的到访时间；疗程内容、价格及当期优惠请于预约前确认。',
      },
      'majesty-spa': {
        name: '尊贵水疗',
        badge: '最豪华',
        description:
          '尊贵水疗位于澳门渔人码头励庭海景酒店内，以华丽装修、宽敞大厅和舒适的休息空间为特色。金色与大理石元素贯穿馆内，十多种不同风格房间搭配沐浴设施、KTV 房及餐饮区，方便按自己的节奏安排休闲时间。\n\n客人可先泡浴或用餐，再按需要了解按摩项目与房间安排。希望深夜留下休息的客人，请提前确认躺椅、独立休息房的供应与收费；预约时也应核对疗程时长、包含项目及总价。',
      },
      'the-excellent-sauna': {
        name: '极品桑拿',
        badge: '24小时',
        description:
          '极品桑拿位于澳门半岛英皇娱乐酒店内，采用较精致的空间规划，设有多款不同设计的房间及传统房型。沐浴、桑拿与休息区相互配合，适合希望从容放松的客人。\n\n到访时可先了解设施，再按按摩项目、时长及预算选择方案。馆内设 24 小时休息区；需要过夜或指定房型，请于预约前确认供应及费用。',
      },
      'empire-sauna': {
        name: '巨亨桑拿',
        badge: '最新 & 最热门',
        description:
          '巨亨桑拿是澳门半岛于 2026 年开业的水疗会所，室内结合现代奢华与东方禅意。大理石浴区、酒店风格套房、餐饮和休息空间串连成完整的休闲动线。\n\n馆内设有水床房、多款不同设计的套房及过夜休息安排，提供台式、日式等按摩风格。预约前可按所需疗程、时长与设施比较方案，并确认当日供应、总价及开业期优惠。',
      },
      'east-castle-spa': {
        name: '东方皇堡水疗',
        badge: '多样房间设计',
        description:
          "东方皇堡水疗位于皇家金堡酒店 3、4 楼，以宽敞的沐浴空间和整洁完善的私人房间为特色。多种风格的房型搭配细致陈设，让每个空间各有格调，也照顾到休息时的舒适感。\n\n会所整体氛围安静雅致，适合希望放慢节奏、从容休息的客人。专业服务团队与舒适环境相互配合，让泡浴和休憩的时间更轻松自在。",
      },
      'victoria-sauna': {
        name: '凯旋桑拿',
        badge: '最安静',
      ...
      'familia-nobre': {
        ...
        badge: '最高性价比',
        description:
          '豪门桑拿殿位于澳门半岛，目前暂停营业，暂不提供到访或预约安排。本页保留过往场馆资料供参考。\n\n旧资料记录了沐浴区、餐饮空间、房间及躺椅休息区。过往价格、免服务费政策及留宿安排均不代表现行优惠；重新开业及最新条款须以场馆日后公布的资料为准。',
      },
      'oceanic-royal-spa': {
        name: '帝湖水疗',
        badge: '大舞台 & 餐饮',
