...
const ko: Dictionary = {
  ...
  spas: {
    heading: '추천 사우나',
    intro:
      '가격, 영업 상태, 직원 규모 등 실용적인 최신 정보와 함께 마카오의 인기 사우나 {venueCount}곳을 살펴보세요.',
    filterLabel: '업소 필터',
    filters: [
      { bucket: 'all', label: '전체' },
    ...
    venues: {
      ...
      'the-excellent-sauna': {
        ...
        description:
          'The Excellent Sauna(디 엑설런트 사우나)는 마카오 반도 Grand Emperor Hotel 안에 자리한 부티크형 테마룸 사우나입니다. 거대한 볼거리 대신 DJ, 오피스, 메디컬, 시네마 설정을 개성 있는 객실로 구현합니다. 편안한 휴식이 목적이라면 일반 독립실을 선택할 수 있습니다.\n\n전체 흐름은 비교적 조용해 붐비는 홀에서 선택하고 싶지 않은 이용객에게 알맞습니다. 먼저 목욕과 사우나를 즐긴 뒤 기분에 따라 객실과 테라피스트를 고르고, 이후 24시간 휴게 공간에서 야간 휴식을 이어갈 수 있습니다. 일정이 유연하고 예산이 중간 정도인 이들에게 대형 업소보다 가벼운 대안입니다.',
      },
      'empire-sauna': {
