...
test("the sitemap contains exactly the 104 localized canonical pages", async () => {
  ...
  assert.equal(canonicalUrls.length, 104, "localized canonical page count changed unexpectedly");
  assert.equal(
